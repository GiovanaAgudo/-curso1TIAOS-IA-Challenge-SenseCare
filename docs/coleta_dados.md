...
02) Coleta de Dados (por Fonte/Sensor)
...
03) Armazenamento e Processamento
No Edge (Local)
...
04) Esquema Base de Evento (JSON)
...
05) Estratégia de Análise (IA Leve + Regras)
...
06) Plano de Simulação (Sprint 1)
Como Simular:
...
07) Privacidade, Segurança e Retenção
